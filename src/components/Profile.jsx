...
export default function Profile() {
  ...
  return (
    <>
      ...
      <div className='px-7 py-7 flex flex-col md:flex md:flex-row md:items-center md:justify-between pt-3'>
        <div className='flex flex-col gap-y-4'>
          <h1 className='text-4xl md:text-4xl font-semibold text-center md:text-justify tracking-tighter'>
            I'm {configData.name}
          </h1>
          <p className='md:w-3/4 text-sm text-gray-500 text-center md:text-justify font-normal tracking-tigh'>
            {configData.desc}
          </p>
        ...
        <div className='rounded-full p-2 flex items-center justify-center mb-7'>
          <div className='w-36 h-36 rounded-full bg-gradient-to-b from-gray-100 to-gray-300 border-2 flex items-center justify-center'>
            <img
              src={'https://avatars.githubusercontent.com/u/36843088?v=4'}
              alt=''
